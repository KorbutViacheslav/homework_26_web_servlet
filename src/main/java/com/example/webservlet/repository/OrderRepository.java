...
public class OrderRepository {
    ...
    public OrderRepository() {
        ...
        Product water = new Product(3L, "Water", new BigDecimal(2));
        List<Product> p = Arrays.asList(cola, beer, water);
        BigDecimal sump = sumCost(p);
        Product salad = new Product(1L, "Salad", new BigDecimal(10));
        Product chicken = new Product(2L, "Chicken", new BigDecimal(15));
